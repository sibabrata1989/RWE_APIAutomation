...
public class GenerateCookies implements ConstantVaribales {
	...
	try
	{
		...
		driver.findElement(By.xpath("//*[@id='ctl00_PageContentPlaceholder_UserNameInput']")).sendKeys("USERNAME");
		driver.findElement(By.xpath("//*[@id='ctl00_PageContentPlaceholder_PasswordInput']")).sendKeys("PASSWORD");
